...
export const FarmList = () => {
  const farmdata = [
    ...
    },
    {
      ...
      location: "Idaho",
      img:
        "https://res-1.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco/ze49mdhvbwppjspapo95",
      item1: "Delivery option available",
    ...
    },
    {
      ...
      location: "Idaho",
      img:
        "https://res-5.cloudinary.com/crunchbase-production/image/upload/c_lpad,h_256,w_256,f_auto,q_auto:eco/v1487649349/gv1c0rn92p06yzc1nv45.jpg",
      item1: "Delivery option available",
      item2: "Pick up available",
